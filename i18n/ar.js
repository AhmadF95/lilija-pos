window.I18N_AR = {
  ...
  appName: "ليليجة — إدارة المتجر (v1.1.0)",
  
  // Header
  modulesLoaded: "وحدات محمّلة: سجل/مستخدمون",
  currentUser: "المستخدم:",
  btnLogout: "🚪 تسجيل خروج",
  btnBackup: "⬇️ تنزيل نسخة احتياطية",
  btnRestore: "⬆️ استعادة",
  ...
  dataMaintenanceTitle: "🛠️ صيانة البيانات",
  dataMaintenanceHint: "عمليات خاصة بالبيانات المحلية في هذا المتصفح فقط.",
  resetHint: "يحذف كل البيانات المحلية (منتجات، مشتريات، مبيعات، إعدادات، مستخدمون) ولا يمكن التراجع.",
